...
$('.waifu-tool .fui-home').click(function (){
    ...
    window.location = window.location.protocol+'//'+window.location.hostname+':2233/'
});
...
$('.waifu-tool .fui-info-circle').click(function (){
    ...
    window.open(window.location.protocol+'//'+window.location.hostname+':2233/');
});
...
(function (){
    ...
    var SiteIndexUrl = window.location.protocol+'//'+window.location.hostname+':2233/';  // 自动获取主页
